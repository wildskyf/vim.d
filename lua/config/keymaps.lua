...
-- adjust window size
map("n", "<leader><up>", ":5winc +<CR>", { desc = "Adjust Window Size (up +5)" })
map("n", "<leader><down>", ":5winc -<CR>", { desc = "Adjust Window Size (down +5)" })
map("n", "<leader><left>", ":5winc <<CR>", { desc = "Adjust Window Size (left +5)" })
map("n", "<leader><right>", ":5winc ><CR>", { desc = "Adjust Window Size (right +5)" })
